  ...
  if(!c.dataset.wired){ c.dataset.wired="1";
    ...
    document.getElementById("tcClaim").addEventListener("click", async()=>{
      ...
      try{
        ...
        const fmt=(x)=> x? (x.size_in+"\\u2033 at "+x.distance_mi+" mi ("+x.date+")") : "none within range";
        const n1=r.nearest&&r.nearest["1.00"], n7=r.nearest&&r.nearest["0.75"];
        tcMsg("Last 12 mo \\u2014 at-address peak "+(r.address_peak_in||0)+"\\u2033. Nearest \\u22651.00\\u2033: "
              +fmt(n1)+". Nearest \\u22650.75\\u2033: "+fmt(n7)+".");
      }catch(e){ tcMsg("Failed \\u2014 "+e.message,true); }
    });
  }
