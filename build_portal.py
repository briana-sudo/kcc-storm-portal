...
.chasehull-lbl{white-space:nowrap;font:700 10px/1.2 system-ui,-apple-system,sans-serif;letter-spacing:.03em;
  color:#f0c078;background:rgba(24,20,12,.82);border:1px solid #c98a2e;border-radius:5px;padding:2px 7px;
  text-shadow:0 1px 2px rgba(0,0,0,.9);transform:translateX(-50%)}
