...
.swathbadge{position:absolute;left:10px;bottom:26px;z-index:640;pointer-events:none;font:600 11px/1.3 system-ui,-apple-system,sans-serif;padding:5px 9px;border-radius:7px;box-shadow:0 2px 8px rgba(0,0,0,.35);letter-spacing:.02em}
...
function updateSwathBadge(cells){
  ...
  if(gated>0){ b.className="swathbadge gated";
    b.textContent='max '+mx.toFixed(2)+'\\u2033 \\u00b7 '+gated+' gated cell'+(gated===1?'':'s'); }
  else { b.className="swathbadge subgate";
    b.textContent='sub-gate \\u00b7 max '+mx.toFixed(2)+'\\u2033 \\u00b7 0 fundable cells'
